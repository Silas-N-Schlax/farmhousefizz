    ...
    return (
      <>
        ...
        <div className="page-hero">
          <span className="eyebrow">{data.locationName ? `${data.locationName}, NC` : "Raleigh–Durham & Central NC"}</span>
        ...
        <div className="article">
          ...
          {data.main && (
            <>
              ...
              <blockquote className="pull">&ldquo;Let&rsquo;s Fizz Things Up&rdquo; &mdash; whether an intimate gathering or a large-scale celebration, we bring handcrafted drinks and memorable service to your guests.</blockquote>

              <div className="cta-inline">
                <Link to="/contact-us" className="btn btn--primary btn--medium">Request a Quote &rarr;</Link>
                <Link to="/menu" className="btn btn--medium">Preview the Menu</Link>
              </div>
          ...
          {!data.main && (
            <>
              ...
              <div className="cta-inline">
                <Link to="/catering" className="btn btn--primary btn--medium">View Full Catering Details &rarr;</Link>
                <Link to="/contact-us" className="btn btn--medium">Request a Quote</Link>
              </div>
            </>
          )}
