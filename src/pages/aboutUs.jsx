    ...
    return (
      <>
        ...
        <article className="article">
          ...
          <p>The journey was anything but easy. From custom-building the trailer by hand to navigating regulations, logistics, and the realities of running a small business, every step required learning, patience, and perseverance. Progress came slowly at times, but always forward.</p>
          <p>With hopes of opening in February 2026, Farmhouse Fizz is the result of countless hours, hard lessons, and a shared commitment to doing things well the first time. What started as an idea has grown into a family-run business focused on quality drinks, friendly service, and creating something lasting together, no matter the challenge along the way.</p>

          <h2>What is a Dirty Soda?</h2>
          <p>The dirty soda, as we know it today, originated in Utah as a non-alcoholic alternative to drinks such as alcohol, tea, and coffee. While the concept has been around for years, it gained widespread popularity around 2010 when Swig opened its first location and helped bring dirty sodas into the mainstream.</p>
          <p>You know the why, but what about the what? A dirty soda has three simple parts, none of which are alcohol. First, a base soda. Second, flavored syrups or fruit juices. Third, cream, typically a sweet cream or half-and-half.</p>
          <blockquote className="pull">Why settle for a plain Dr. Pepper when you could have a creamy vanilla blackberry Dr. Pepper?</blockquote>
          <p>Before you click away in disgust, hear us out. Before we tried it, we thought it sounded like a terrible idea too. Who adds cream to soda? That said, once we tried it, there was no going back.</p>

          <h2>Our Setup</h2>
          <p>Farmhouse Fizz Soda Bar operates from a self-contained concession trailer with a farmhouse vibe. We are set up for all types of events, from street vending and festivals to corporate events, weddings, and backyard parties.</p>
